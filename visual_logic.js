 ...
 * Tue Jul 13 2021 14:11:07 GMT+0800 (中国标准时间)
...
setMaterialColor('colorlight', 'RGB', 0, 0, 0, '');
...
registerOnHover('<none>', false, function() {}, function() {});

['ALL_OBJECTS'];

cloneObject('<none>');

loadScene('path/to/scene.gltf', 'path/to/scene.gltf', function() {}, function() {}, function() {});
appendScene('path/to/scene.gltf', 'path/to/scene.gltf', false, false, function() {}, function() {}, function() {});
